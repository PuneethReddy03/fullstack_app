pipeline {
    ...
    environment {
        ...
        TOMCAT_URL = 'http://54.164.72.238:9090/manager/text'
        TOMCAT_USER = 'Puneeth'
        TOMCAT_PASS = 'Punith@03'
    ...
    post {
        success {
            echo "✅ Backend deployed: http://54.164.72.238:9090/springapp1"
            echo "✅ Frontend deployed: http://54.164.72.238:9090/frontapp1"
        }
        failure {
